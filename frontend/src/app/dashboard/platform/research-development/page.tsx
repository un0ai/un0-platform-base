        ...
        <Tabs defaultValue="capabilities" className="space-y-6">
          <div className="flex justify-center w-full">
            <TabsList className="w-[600px]">
              <TabsTrigger value="capabilities" className="flex-1">Platform Capabilities</TabsTrigger>
              <TabsTrigger value="integration" className="flex-1">Integration Guide</TabsTrigger>
              <TabsTrigger value="examples" className="flex-1">Example Use Cases</TabsTrigger>
            </TabsList>
          </div>
